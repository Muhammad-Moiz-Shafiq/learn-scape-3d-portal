        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          ...
          <div ref={statsRef} className="space-y-6">
            <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
              ...
              <p className="mt-2 text-sm text-gray-600">75% of monthly goal</p>
            </div>
            
            <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-xl font-semibold text-gray-800">Active Students</h3>
                <Users className="text-edtech-accent" size={20} />
              </div>
              <div className="flex items-baseline">
                <span className="text-3xl font-bold text-gray-800">847</span>
                <span className="ml-2 text-green-600 flex items-center">
                  <TrendingUp size={16} className="mr-1" />
                  23%
                </span>
              ...
              <div className="mt-4 flex -space-x-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-edtech-primary/80 to-edtech-accent/80 border border-white flex items-center justify-center">
            ...
            <div className="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
              ...
              <p className="mt-2 text-sm text-gray-600">Based on 120 reviews</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div ref={dashboardRef} className="relative">
              {/* Dashboard Frame */}
              <div className="bg-white backdrop-blur-xl rounded-2xl border border-gray-200 shadow-lg p-4 overflow-hidden">
                {/* Dashboard Header */}
                <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <h3 className="font-medium text-gray-800">Professor Dashboard</h3>
                      <p className="text-sm text-gray-600">Welcome back, Prof. Alex</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="md:w-1/4 bg-gray-100 rounded-xl p-4">
                    <nav className="space-y-2">
                      {['Dashboard', 'Courses', 'Students', 'Analytics', 'Earnings', 'Settings'].map((item, i) => (
                        <div 
                          key={i}
                          className={`p-2 rounded-lg cursor-pointer transition-colors ${
                            i === 0 ? 'bg-gradient-to-r from-edtech-primary/20 to-edtech-accent/20 text-gray-800' : 'text-gray-600 hover:bg-gray-200'
                          }`}
                        >
                          {item}
                        </div>
                  ...
                  {/* Right Panel - Content */}
                  <div className="md:w-3/4 bg-gray-100 rounded-xl p-4">
                    <h3 className="text-lg font-medium text-gray-800 mb-4">Course Performance</h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm text-gray-500 pb-1 border-b border-gray-300">
                        <span>Course</span>
                        <span>Revenue</span>
                      </div>
                      ...
                      {['Advanced AI', 'Frontend Dev', 'Data Science', 'UX Design'].map((course, i) => (
                        <div key={i} className="flex justify-between py-2 border-b border-gray-200">
                          ...
                          <span className="text-gray-800">${(1000 - i * 220).toLocaleString()}</span>
                        </div>
                      ))}
                    </div>
                  </div>
